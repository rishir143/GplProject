        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black mb-6 font-orbitron uppercase tracking-wider">The <span className="text-hacker-cyan">Qualifier</span></h3>
              <p className="text-white/50 mb-10 leading-relaxed text-lg font-space">
              ...
              <ul className="space-y-4 text-sm font-space text-white/40">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black mb-6 font-orbitron uppercase tracking-wider">The <span className="text-hacker-cyan">Grand Finale</span></h3>
              <p className="text-white/50 mb-10 leading-relaxed text-lg font-space">
