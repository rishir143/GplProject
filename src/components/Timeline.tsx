      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          {events.map((event, idx) => (
            ...
            >
              {/* Dot on the timeline */}
              <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 w-4 h-4 bg-hacker-cyan rounded-full shadow-[0_0_15px_#00c2ff] z-10 group-hover:scale-150 transition-transform duration-500" />
