      ...
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="relative mb-8">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[10rem] font-black leading-[0.9] tracking-[-0.04em] text-white font-orbitron text-pop">
          ...
          >
            <p className="text-lg md:text-2xl lg:text-4xl font-bold text-white mb-6 tracking-[0.1em] font-orbitron uppercase text-pop brightness-125">
              Galgotias Programming League
            </p>
            <p className="text-sm md:text-lg lg:text-2xl text-hacker-cyan font-orbitron mb-12 md:mb-16 tracking-[0.4em] md:tracking-[0.6em] uppercase font-black text-pop brightness-110">
          ...
          <Motion.div 
            ...
            className="flex flex-wrap justify-center gap-6 md:gap-16 mb-16 md:mb-24 text-white/80"
          >
            {[
              ...
              <div key={idx} className="flex flex-col items-center gap-3 md:gap-4 group">
                <div className="p-4 md:p-6 rounded-2xl bg-white/5 border border-white/10 group-hover:border-hacker-cyan/50 group-hover:bg-hacker-cyan/5 transition-all duration-500 backdrop-blur-xl shadow-[0_0_30px_rgba(0,194,255,0.05)] group-hover:shadow-[0_0_40px_rgba(0,194,255,0.2)]">
                  <item.icon className="text-hacker-cyan w-6 h-6 md:w-8 md:h-8 filter drop-shadow-[0_0_12px_rgba(0,194,255,0.8)] brightness-125" />
                </div>
                <span className="text-[10px] md:text-sm font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/70 group-hover:text-white transition-colors font-orbitron text-pop">{item.text}</span>
              </div>
            ))}
          </Motion.div>
